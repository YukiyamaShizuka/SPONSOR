...
| 1        | **Dell PowerEdge XE9680L** — **2** × Intel Xeon Platinum 8593Q (**64** cores each, **128** cores total)  ·  System Memory: **4** TB DDR5-5600 RECC DIMM  ·  GPU: **8** x **NVIDIA** HGX **B200 180GB** 1000W SXM6 GPUs, fully interconnected with NVIDIA NVLink technology  ·   System Storage: 1 x **4** TB PCIe5.0 M.2 ssd  ·  Data Storage: 8 x 2.5-inch NVMe SSD drives max 122.88 TB  ·  Security Bezel|
