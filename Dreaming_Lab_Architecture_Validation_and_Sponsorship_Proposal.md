...
- **Monitors:**
  ...
  - Samsung 114" MicroLED Display (Model: MNA114MS1CCXXZ) — Fixed Wall-Mount Installation, paired with Intel NUC13 5090FE PC (Core i9-13900K, 64GB DDR5 RAM, 2TB NVMe SSD,5090FE,Enermax PlatiGemini1200 12VO 1200W Power Supply Unit) for local media processing, visualization handling, and VPN-integrated content routing.
...
- **Basement Level (Dedicated Subsurface Machine Room and Compute Core):**
  - The entire underground level shall undergo full-scale industrial datacenter-grade reconstruction to house all heavy laboratory infrastructure:
