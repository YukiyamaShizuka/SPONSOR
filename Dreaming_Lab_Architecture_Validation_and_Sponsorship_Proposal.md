...
- **First Floor (Independent Family Residential Area):**
  ...
  - The first floor shall retain full residential design and construction, adopting only standard home-grade finishing consistent with modern high-quality detached residential properties.
  - Electrical wiring, plumbing systems, HVAC installation, flooring, cabinetry, and insulation shall fully comply with normal residential standards.
  - No laboratory-class hardware, compute infrastructure, environmental control systems, or industrial overengineering shall be installed on this floor, ensuring that sponsor capital remains fully allocated to dedicated laboratory infrastructure on the second level.

- **Second Floor (Dedicated Dreaming Lab Architecture Zone):**
  - This level serves as the exclusive operational domain of the Dreaming Lab system:
    - The primary master bedroom will remain allocated as developer personal residence quarters, physically isolating living and rest space for long-cycle development stability.
    - One secondary room will undergo full-scale technical reconstruction to serve as the primary Lab semantic execution workspace, housing architecture development consoles, semantic path monitors, high-resolution rendering displays (including the 98" 8K Neo QLED wall-mounted panel), software compiler workstations, AI system debuggers, and simulation visualizers.
    - A second secondary room will be fully converted into the machine room, hosting AI server racks, NVL72 compute nodes, UPS systems, liquid cooling equipment, industrial-grade airflow management, acoustic isolation paneling, vibration suppression structures, and independent high-capacity electrical circuits connected to external industrial power feeds fully separated from residential electrical subsystems.
    - The remaining smaller auxiliary room will be reconstructed into a fully isolated private technical office and documentation workspace, supporting system design, long-cycle architectural verification, theoretical research consolidation, and administrative management.
    - The original en-suite utility zone attached to the master bedroom will be converted into a sealed technical library room, housing physical reference books, archived architecture specifications, printed semantic execution datasets, and multi-year documentation logs for historical development traceability.
    - The south-facing balcony attached to the master bedroom will remain fully residential, furnished as a rest and decompression area for long-session psychological stability, positioned intentionally away from technical infrastructure zones to ensure cognitive recovery balance.
    - All laboratory work areas (both Lab Room and Machine Room) will be protected via industrial-grade electronic access control, ensuring personnel isolation, operational safety, and strict environmental compartmentalization.
