...
**For full-stack architecture exploration:**  
→ **[View Dreaming full-stack sponsorship configuration](./Dreaming_X86_Hardware_Sponsorship_Request.md)**
...
Porting to the second platform may follow, but is not guaranteed.
