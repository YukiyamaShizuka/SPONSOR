...
- **Cables:**    
 1. **NVIDIA NVLink Bridges**  
   - Quantity: 3  
   - Specification: NVIDIA 2-Way NVLink Bridge (H200 NVL)  

 2. **Ethernet Cables**  
   - Quantity: 3  
   - Specification: ASUS ROG ZOOM CAT7, 3 m length  

 3. **Display Cables**  
   - Quantity: 4  
   - Specification: 10 m Active Optical DisplayPort™ 2.1 Cables (e.g., StarTech™ Fiber DP2.1)  
